...
// =========================================================
// NUEVO: estado visual del pasajero
// false = esperando taxi (blanco)
// true  = taxi confirmado en camino (amarillo)
// Se resetea automáticamente cuando el pasajero desaparece
// del mapa (lo saca Despachador.moverFlota al ser recogido).
// =========================================================
private boolean confirmado = false;
 
public boolean isConfirmado() { return confirmado; }
public void setConfirmado(boolean c) { this.confirmado = c; }
...
public String getCalleA() { return calleA; }
public String getCalleB() { return calleB; }
public long getId() { return id; }
public double getLatitud() { return latitud; }
public double getLongitud() { return longitud; }
public String getNombreEsquina(){ return this.nombreEsquina; }
...
private double obtenerVelocidadMS(String tipoVia) {
    if (tipoVia == null) return 5.0;
    switch (tipoVia.toLowerCase()) {
        case "primary":     return 45.0 / 3.6;
        case "secondary":   return 35.0 / 3.6;
        case "residential":
        case "tertiary":    return 25.0 / 3.6;
        default:            return 20.0 / 3.6;
    }
}
}
